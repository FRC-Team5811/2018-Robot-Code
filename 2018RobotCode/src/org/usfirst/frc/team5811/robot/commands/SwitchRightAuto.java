...
public class SwitchRightAuto extends CommandGroup {
	...
	int waitTime = 50;
	public SwitchRightAuto(double driveTime1, double driveDirection1, double turnAngle1, double turnDirection1, double DT2, double DD2, double TA2, double TD2, double DT3, double DD3) {
		/*
